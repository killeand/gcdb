...
export default class Button extends Component {
    render() {
        ...
        if (newType != null)
            return React.createElement(newType, {...newProps, className:classProp + " border-2 border-black rounded-xl px-2 py-1"}, this.props.children);
        else
            return React.createElement("button", {...newProps, className:classProp + " border-2 border-black rounded-xl px-2 py-1"}, this.props.children);
    }
}